...
Revision ID: 561aec49ca8c
Revises: 
Create Date: 2023-11-27 15:58:59.368307
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['comment_id'], ['comments.id'], name=op.f('fk_recipes_comment_id_comments')),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('chef_id', sa.Integer(), nullable=True),
    sa.Column('recipe_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['chef_id'], ['chefs.id'], name=op.f('fk_commendsadasts_chef_id_chefs')),
    sa.ForeignKeyConstraint(['recipe_id'], ['recipes.id'], name=op.f('fk_commendsadasts_recipe_id_recipes')),
    sa.PrimaryKeyConstraint('id')
    )
